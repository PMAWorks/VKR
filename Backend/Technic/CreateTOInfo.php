...
$stmt = $Technic->createTOInfo($Des, $Date, $Price, $TechnicID, $EndDate);

$stmt = $Technic->GetTOInfo($TechnicID);
$num = $stmt->rowCount();
...
if ($num>0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($products_arr["TOInfo"], $product_item);
    }
