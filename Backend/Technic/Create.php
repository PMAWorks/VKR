...
$TechnicType = $_POST["TechnicType"];
$Name = $_POST["Name"];
$TechnicPhoto = $_POST["TechnicPhoto"];
$TechnicParam = $_POST['TechnicParam'];
// прочитаем детали товара для редактирования

$stmt = $Technic->create($RegNumber, $TechnicType, $Name, $TechnicPhoto, $TechnicParam);
...
if ($num>0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($products_arr["Technic"], $product_item);
    }
