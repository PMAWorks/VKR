...
$PolomkaID = $_POST['PolomkaID'];
// прочитаем детали товара для редактирования

$stmt = $Technic->SetPolomkaSeen($PolomkaID);

$stmt = $Technic->GetNewPolomka();
$num = $stmt->rowCount();
...
if ($num>0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($products_arr["NewPolomka"], $product_item);
    }
