...
$Technic->createNewTechnicOnObject($ObjectID, $TechnicID, $Start, $End);

// прочитаем детали товара для редактирования

$stmt = $Technic->ReadTechnicOnObject($ObjectID);
$num = $stmt->rowCount();
...
if ($num>0) {
    ...
    // массив товаров 
    $products_arr=array();
    $products_arr["TechnicOnObject"]=array();
    ...
    array_push($products_arr["TechnicOnObject"], $product_item);
    }
