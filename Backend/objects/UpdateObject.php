...
$Price = $_POST['Price'];
$Avans = $_POST['Avans'];
$CreateObjectPhotoPreview = $_POST['CreateObjectPhotoPreview'];
$ObjectID = $_POST['ObjectID'];

// прочитаем детали товара для редактирования

$stmt = $Objects->UpdateObject($ObjectID, $Adres, $ObjectName, $ObjectType, $StartDate, $EndDate, $Price, $Avans, $CreateObjectPhotoPreview);
