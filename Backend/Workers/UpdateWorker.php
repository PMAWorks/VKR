...
$Salary = $_POST['Salary'];
$Avans = $_POST['Avans'];
$TechnicPreviewPhoto = $_POST['TechnicPreviewPhoto'];
...
$stmt = $Workers->UpdateWorker($Name, $PassportSer, $PassportNumber, $Adress, $StartDate, $EndDate, $BirthDay, $Salary, $Avans, $TechnicPreviewPhoto, $ObjectID, $Phone, $Email, $WorkerID);
